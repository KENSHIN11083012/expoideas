...
const FASES = [
    {
        ...
        acento: 'primary',
        icon: Lightbulb,
        titulo: 'Postula tu idea o prototipo',
        texto: 'Proyectos de aula, semilleros y primeros prototipos se postulan con su equipo y reciben la evaluación de jurados con criterios comunes.',
        puntos: ['Postulación en línea con tu equipo y mentor', 'Evaluación por jurados con rúbrica', 'Retroalimentación para seguir mejorando'],
    },
    {
        fase: 'Fase II',
        nombre: 'Vitrina',
        acento: 'lima',
        icon: Store,
        titulo: 'Muestra tu emprendimiento',
        texto: 'Los emprendimientos con producto validado se exhiben en una vitrina abierta para conectar con clientes, mentores y aliados de la región.',
        puntos: ['Ficha pública del emprendimiento', 'Contacto con aliados y clientes', 'Acompañamiento de MacondoLab'],
    },
];

const PERFILES = [
    { icon: UserRound, titulo: 'Estudiantes y egresados', texto: 'Postulan sus ideas y emprendimientos y siguen su evolución.' },
    { icon: GraduationCap, titulo: 'Docentes y mentores', texto: 'Acompañan a los equipos y respaldan sus proyectos.' },
    { icon: Scale, titulo: 'Jurados', texto: 'Evalúan las propuestas con criterios transparentes.' },
    { icon: Handshake, titulo: 'Aliados', texto: 'Descubren talento y proyectos con potencial en la región.' },
];
                ...
                <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-14 sm:px-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] lg:px-8 lg:py-24">
                    <div className="flex min-w-0 flex-col gap-6">
                        ...
                        <p className="max-w-xl text-lg leading-relaxed text-on-surface-variant">
                            Expoideas reúne los proyectos y emprendimientos de estudiantes y egresados: aquí se postulan,
                            se evalúan con jurados y se dan a conocer ante la comunidad, mentores y aliados.
                        </p>
            ...
            <section className="mx-auto flex max-w-7xl flex-col gap-10 px-4 py-20 sm:px-6 lg:px-8" aria-labelledby="ruta-titulo">
                <div className="flex max-w-2xl flex-col gap-3">
                    ...
                    <h2 id="ruta-titulo" className="font-heading text-3xl font-bold tracking-tight sm:text-4xl">
                        De la idea al mercado, en dos fases
                    </h2>
                    <p className="text-on-surface-variant">
                        Un recorrido pensado para que ninguna buena idea se quede en el papel: primero se valida con
                        jurados y después se muestra a quienes pueden impulsarla.
                    </p>
                </div>
                ...
                <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-4 py-16 sm:px-6 lg:flex-row lg:items-center lg:px-8">
                    <div className="flex max-w-2xl flex-col gap-3">
                        <h2 id="cta-titulo" className="font-heading text-3xl font-bold tracking-tight text-on-primary sm:text-4xl">
                            {autenticado ? 'Tu cuenta está lista' : '¿Tienes una idea o un emprendimiento?'}
                        </h2>
                        <p className="text-on-primary-container">
                            {autenticado
                                ? 'Revisa que tus datos estén al día para cuando se abra la próxima convocatoria.'
                                : 'Crea tu cuenta con el correo institucional y prepárate para la próxima convocatoria.'}
                        </p>
                    </div>
